...
class Trainer:
    def __init__(self):
        ...
        self.parser.add_argument('dataset', help='which dataset')
        self.parser.add_argument('opt', help='flow?')
        self.parser.add_argument('--model', help='model to use')
        self.parser.add_argument('-j', '--workers', default=1, type=int, metavar='N',
                                 help='number of data loading workers')
        self.parser.add_argument('-b', '--batch-size', default=32, type=int, metavar='N', help='mini-batch size')
...
class Tester:
    def __init__(self):
        ...
        self.parser.add_argument('--num_heads', default=12, type=int, help='number of heads in multi-head attention module')
        # self.parser.add_argument('--num_hiddens', default=16, type=int, help='dimension of hidden layers in RNN')
        # self.parser.add_argument('--rnn_type', default='gru', type=str, help='type of RNN')
